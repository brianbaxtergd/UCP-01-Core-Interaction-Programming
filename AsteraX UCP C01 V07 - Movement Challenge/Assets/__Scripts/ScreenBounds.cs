...
public class ScreenBounds : MonoBehaviour
{
    ...
    {
        // Check is anything has changed about cam.orthographicSize or cam.aspect.
        // If those values are the same as chached, then there is no need to change the localScale of this.transform.
        if (cam.orthographicSize != cachedOrthographicSize
    ...
    private Vector3 CalculateScale()
    {
        ...
        // Assigning the result of this ComponentDivide to a variable makes debugging easier because you can see the value before it is returned.
        return scaleColl;
    }

    // Returns a random point that will be on-screen.
    ...
    static public bool OOB(Vector3 worldPos)
    {
        ...
        // Find which dimension the losPos is furthest from the origin.
