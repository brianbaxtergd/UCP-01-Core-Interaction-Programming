// Used to test a case where some Asteroids were getting lost off screen.
// #define DEBUG_Asteroid_Test00BVel
...
public class Asteroid : MonoBehaviour
{
    ...
    // NOTE: Allowing parentIsAsteroid and parentAsteroid to call GetComponent<> everytime is inefficient,
    // however, this only happens when a bullet hits an Asteroid which is rarely enough that it isn't a performance hit.
    ...
    public void InitAsteroidChild()
    {
        ...
        // Make use of this ComponentDivision extension method in Vector3Extensions.
    ...
    public void InitVelocity()
    {
        ...
        {
            // If the Asteroid is OOB, just point it toward a point near the center of the screen.
        ...
        {
            // If in bounds, choose a random direction and make sure when you Normalize it, it doesn't have a length of 0
            // (which might happen if Random.insideUnitCircle returned [0, 0, 0].
            do
            {
